                  ...
                  <div className='flex bottom'>
                    <div>
                      <p className='quantity-desc'>
                          <span onClick={() => toggleCartItemQuantity(item?._id, 'dec')} className='minus'><AiOutlineMinus /></span>
                          <span className='num'>{item?.quantity}</span>
                          <span onClick={() => toggleCartItemQuantity(item?._id, 'inc')} className='plus'><AiOutlinePlus /></span>
                      </p>
                    </div>
                    <button onClick={() => onRemove(item)} className='remove-item' type='button'><TiDeleteOutline /></button>
                  </div>
                </div>
              </div>
            ))
